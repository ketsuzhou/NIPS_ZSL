...
def create_model(args, simulator):
    ...
    elif args.algorithm in ["mf", "gamf", "pie"] and not args.specified and not simulator.is_image(): model = create_vector_mf(args, simulator)
...
def create_image_emf(args, c, h, simulator, w):
    ...
    # TODO can be replaced by the Encoder of NVAE
