...
if __name__ == '__main__':
    ...
    parser.add_argument('--root', type=str, default='NVAE/expr',
    ...
    parser.add_argument('--data', type=str, default='NVAE/tmp/nasvae/data',
    ...
    # Flow params
    parser.add_argument('--num_nf', type=int, default=2,
